        ...
        <div className="flex max-w-md">
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col bg-base-300 p-8 w-full rounded-md shadow-xs">
                ...
                <div className="flex flex-col mt-5">
                    ...
                    <input type="text" id="displayname" placeholder="Enter your display name..." className="input w-full" {...register("displayName", {required: "Display Name is required"})} />
                    {errors.displayName && (
                ...
                <div className="flex flex-col mt-5">
                    ...
                    <input type="password" id="confirmPassword" placeholder="Enter your confirm password..." className="input w-full" {...register("confirmPassword", {required: "Confirm Password is required", minLength: { value: 8, message: "Password must be at least 8 characters long" }})} />
                ...
                <button type="submit" disabled={isSubmitting} className="btn btn-success text-white my-5">{isSubmitting ? "Loading..." : "Signup"}</button>
            </form>
        </div>
    </div>
  )
